...
// Ensure that CAN_BIT_FIELD.h is correctly named and available in your project
...
/* Macros to enable NVIC interrupts for CAN */
#define NVIC_IRQ19_CAN1_TX_Enable()     (NVIC_ISER0 |= (1 << 19))
#define NVIC_IRQ20_CAN1_RX0_Enable()    (NVIC_ISER0 |= (1 << 20))
#define NVIC_IRQ21_CAN1_RX1_Enable()    (NVIC_ISER0 |= (1 << 21))
#define NVIC_IRQ22_CAN1_SCE_Enable()    (NVIC_ISER0 |= (1 << 22))

/* Macros to disable NVIC interrupts for CAN */
#define NVIC_IRQ19_CAN1_TX_Disable()    (NVIC_ICER0 |= (1 << 19))
#define NVIC_IRQ20_CAN1_RX0_Disable()   (NVIC_ICER0 |= (1 << 20))
#define NVIC_IRQ21_CAN1_RX1_Disable()   (NVIC_ICER0 |= (1 << 21))
#define NVIC_IRQ22_CAN1_SCE_Disable()   (NVIC_ICER0 |= (1 << 22))
...
//Structure definition for CAN register
typedef struct
{
...
// Structure definition for FLASH registers
typedef struct {
...
#define RCC_CAN1_Reset()			(RCC->APB1RSTR |= 1<<25)
...
#define CAN_SJW_2TQ                 (0x00000001U)              /*!< 2 time quantum */
#define CAN_SJW_3TQ                 (0x00000002U)              /*!< 3 time quantum */
#define CAN_SJW_4TQ                 (0x00000003U)              /*!< 4 time quantum */
/**
  * @}
  */
...
#define CAN_BS2_2TQ                 (0x00000001U)                                /*!< 2 time quantum */
#define CAN_BS2_3TQ                 (0x00000002U)                                /*!< 3 time quantum */
#define CAN_BS2_4TQ                 (0x00000003U)                                /*!< 4 time quantum */
#define CAN_BS2_5TQ                 (0x00000004U)                                /*!< 5 time quantum */
#define CAN_BS2_6TQ                 (0x00000005U)                                /*!< 6 time quantum */
#define CAN_BS2_7TQ                 (0x00000006U)                                /*!< 7 time quantum */
#define CAN_BS2_8TQ                 (0x00000007U)                                /*!< 8 time quantum */
/**
  * @}
  */
...
#define __HAL_CAN_GET_FLAG(__HANDLE__, __FLAG__) \
  ((((__FLAG__) >> 8U) == 5U) ? ((((__HANDLE__)->Instance->TSR) & (1U << ((__FLAG__) & CAN_FLAG_MASK))) != 0U) : \
   (((__FLAG__) >> 8U) == 2U) ? ((((__HANDLE__)->Instance->RF0R) & (1U << ((__FLAG__) & CAN_FLAG_MASK))) != 0U) : \
   (((__FLAG__) >> 8U) == 4U) ? ((((__HANDLE__)->Instance->RF1R) & (1U << ((__FLAG__) & CAN_FLAG_MASK))) != 0U) : \
   (((__FLAG__) >> 8U) == 1U) ? ((((__HANDLE__)->Instance->MSR) & (1U << ((__FLAG__) & CAN_FLAG_MASK))) != 0U) : \
   (((__FLAG__) >> 8U) == 3U) ? ((((__HANDLE__)->Instance->ESR) & (1U << ((__FLAG__) & CAN_FLAG_MASK))) != 0U) : 0U)
...
//void CAN_TX(uint32_t ID , uint8_t DLC , uint8_t* payload , uint8_t polling_enable);
//void CAN_RX(uint32_t *ID , uint8_t *DLC , uint8_t* payload, uint8_t polling_enable);
void CAN_TX(uint32_t ID , uint8_t DLC , uint8_t* payload ,uint8_t polling_enable );
